<template>
  ...
  <svg
    v-else-if="props.name === 'volume-up'"
    xmlns="http://www.w3.org/2000/svg"
    fill="none"
    viewBox="0 0 24 24"
    stroke="currentColor"
  ...
  /></svg>
  <svg
    v-else-if="props.name === 'calculator'"
    xmlns="http://www.w3.org/2000/svg"
    fill="none"
    viewBox="0 0 24 24"
    stroke="currentColor"
